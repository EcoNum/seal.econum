...
La laboratoire d'Ecologie numérique de l'Université de mons a un autoanalyseur **seal AA3**
L'autoanalyseur **seal AA3**


```{r}
aa3 <- readr::read_delim(file = "../inst/extra_data/181009A.TXT", 
                            delim = ";",
                            col_names = FALSE,
                            col_types = readr::cols( .default = "c"),
                            locale = readr::locale(encoding = "LATIN1")) # particulary
knitr::kable(aa3[0:20, ], align = "c")
```
